...
class Body 
{
	...
	public var constraints : GenericStack<Constraint>;
	...
	public function new() 
	{
		...
		constraints = new GenericStack<Constraint>();
		SetAngle(0);
		SetMass(1);
	...
	public function AddFeature(shape:GeometricShape,material:Material = null):Feature  {
		var feature = new Feature(this, shape, material == null ? new Material() : material);
